...
export default {
  methods: {
    ...
    getOpenid(code) {
      ...
      // const appid = "wxe8bf612577a7aac0";// 米斯特吴
      // const secret = "b66a1ddcc7426e5453f73c75a9dd705a";// 米斯特吴
      const appid = "wx2943c80cf50dccaf";
      const secret = "2a84347b808cbd13c865e7b9b8420b3d";
      this.$https
        .request({
